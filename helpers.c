...
char *get_user_json_format_string()
{
    char username[SMALL_SIZE], password[SMALL_SIZE];
    printf("username=");
	scanf("%s", username);
	printf("password=");
	scanf("%s", password);
...
/* Verifica daca numarul de pagini introdus este un numar */
...
char *get_book_json_format_string()
{
    char title[SMALL_SIZE], author[SMALL_SIZE], genre[SMALL_SIZE], publisher[SMALL_SIZE], pages[SMALL_SIZE];
